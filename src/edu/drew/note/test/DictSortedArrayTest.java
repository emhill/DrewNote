...
import edu.drew.note.DictSortedArray;
import edu.drew.note.Note;

	public class DictSortedArrayTest extends TestCase {
		private static final int SIZE = 100;
		private Note[] array = new Note[SIZE];
		private Note[] shuffled = new Note[SIZE];
		private DictSortedArray notes = new DictSortedArray();
